...
## Running eval.py
To print out the passing rate of the app, run `python3 eval.py.` Sometimes the passing rate is 15/18 or 16/18 and sometimes it can be 2/18 or 4/18. (I was not able to test since I ran out of quota values)
